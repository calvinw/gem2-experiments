...
class SettingsManager {
    ...
    initializeElements() {
        ...
        this.elements = {
            ...
            responseModalitySelect: this.dialog.querySelector('#responseModality'),
    ...
    loadSettings() {
        ...
        this.elements.responseModalitySelect.value = localStorage.getItem('responseModality') || 'audio';
    ...
    saveSettings() {
        ...
        localStorage.setItem('responseModality', this.elements.responseModalitySelect.value);
        ...
        console.log('Saved responseModality to localStorage:', this.elements.responseModalitySelect.value);
    }
    ...
    show() {
        ...
        this.loadSettings(); // Load settings every time dialog is shown
