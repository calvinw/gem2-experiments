...
<form class="settings-form">
    ...
    <div class="settings-group">
        <label for="responseModality">Response Modality</label>
        <select id="responseModality" name="responseModality">
    ...
    <button type="button" id="settingsSaveBtn" class="settings-save-btn">Save Settings</button>
</form>`;
